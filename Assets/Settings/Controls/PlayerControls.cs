...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""ShowEnemyInformation"",
                    ""type"": ""Button"",
                    ""id"": ""28628228-0a53-4994-8ead-e55c7b644aa5"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""28ac5f42-257a-4965-9478-9e43059a0e63"",
                    ""path"": ""<Keyboard>/f1"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ShowEnemyInformation"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_Keyboard_ShowEnemyInformation = m_Keyboard.FindAction("ShowEnemyInformation", throwIfNotFound: true);
    ...
    ~@PlayerControls()
    {
        Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, PlayerControls.Mouse.Disable() has not been called.");
        Debug.Assert(!m_Keyboard.enabled, "This will cause a leak and performance issues, PlayerControls.Keyboard.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Keyboard_ShowEnemyInformation;
    ...
    public struct KeyboardActions
    {
        ...
        public InputAction @ShowEnemyInformation => m_Wrapper.m_Keyboard_ShowEnemyInformation;
        ...
        public void AddCallbacks(IKeyboardActions instance)
        {
            ...
            @ShowEnemyInformation.started += instance.OnShowEnemyInformation;
            @ShowEnemyInformation.performed += instance.OnShowEnemyInformation;
            @ShowEnemyInformation.canceled += instance.OnShowEnemyInformation;
    ...
    public interface IKeyboardActions
    {
        ...
        void OnShowEnemyInformation(InputAction.CallbackContext context);
