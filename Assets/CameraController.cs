...
public class CameraController : Controller
{
    ...
    void ApplyValues()
    {
        ...
        _transform.position = Vector3.Lerp(_transform.position, _newPosition, Time.unscaledDeltaTime * _smoothingTime);
        _transform.rotation = Quaternion.Lerp(_transform.rotation, _newRotation, Time.unscaledDeltaTime * _smoothingTime);
