...
public static class PredefinedAssemblyUtil
{
	...
	public static List<Type> GetTypes(Type interfaceType)
	{
		...
		_ = assemblyTypes.TryGetValue(AssemblyType.AssemblyCSharp, out var assemblyCSharpTypes);
		AddTypesFromAssembly(assemblyCSharpTypes, interfaceType, types);

		_ = assemblyTypes.TryGetValue(AssemblyType.AssemblyCSharpFirstPass, out var assemblyCSharpFirstPassTypes);
